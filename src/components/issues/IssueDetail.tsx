...
export default function IssueDetail() {
  ...
  const handleAssign = async () => {
    ...
    try {
      await updateMutation.mutateAsync({ 
        id: issue.id, 
        data: { assignedTo: selectedTechnician, status: 'assigned' } 
      });
  ...
  return (
    <div className="space-y-6">
      <Meta 
        title={`${issue.title} | CitiScope`} 
        description={`Details for issue ${issue.id}: ${issue.description.substring(0, 100)}...`}
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              {technician ? (
                <div className="flex items-center gap-3 rounded-lg border p-3">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => setIsAssignModalOpen(true)}>Change</Button>
                </div>
              ) : (
                <Button className="w-full" onClick={() => setIsAssignModalOpen(true)}>Assign Technician</Button>
              )}
              <Button variant="outline" className="w-full" onClick={() => setIsStatusModalOpen(true)}>Update Status</Button>
            </CardContent>
          </Card>
          ...
          <Modal
            ...
            description="Select a technician to handle this issue."
          >
            <div className="space-y-4 py-4">
              ...
              <Button className="w-full" onClick={handleAssign} disabled={updateMutation.isPending}>
                Confirm Assignment
              </Button>
            </div>
          </Modal>
          ...
          <Modal
            ...
            description="Change the current status of the infrastructure issue."
          >
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                <Label>New Status</Label>
                <Select onValueChange={setSelectedStatus} defaultValue={issue.status}>
                  <SelectTrigger>
              ...
              <Button className="w-full" onClick={handleUpdateStatus} disabled={updateMutation.isPending}>
                Update Status
              </Button>
            </div>
          </Modal>
