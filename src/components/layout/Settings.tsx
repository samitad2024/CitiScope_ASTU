...
export default function Settings() {
  ...
  return (
    <div className="space-y-6">
      <Meta 
        title="Settings | CitiScope" 
        description="Manage your account and system preferences for the CitiScope platform."
      />
      <div>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label className="text-base flex items-center gap-2"><Activity className="h-4 w-4" /> Data Source Mode</Label>
                      <p className="text-sm text-muted-foreground">
                        Current mode: <Badge variant="outline" className="ml-1 uppercase">{import.meta.env.VITE_USE_MOCK === 'true' ? 'Mock Data' : 'Live API'}</Badge>
                      </p>
                    </div>
                  </div>
                  <div className="bg-muted/50 p-4 rounded-lg border border-dashed">
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      To switch between Mock and Live API modes, update the <code className="bg-muted px-1 rounded">VITE_USE_MOCK</code> variable in your <code className="bg-muted px-1 rounded">.env</code> file and restart the development server.
                    </p>
                  </div>
                </div>
